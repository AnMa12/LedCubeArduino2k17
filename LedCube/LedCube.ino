  ...
  int column[16]={13,12,11,10,9,8,7,6,5,4,3,2,A7,A6,A5,A4}; //initializing and declaring led rows
  int time = 250;
...
void loop() {
  ...
  delay(1000);
  setColor(102, 255, 255); //Ivory Color
  delay(1000);
  setColor(153, 51, 102); //Visiuniu Color
  delay(1000);
  ...
  delay(1000);
  setColor(102, 255, 102); //Neon Color
  delay(1000);
